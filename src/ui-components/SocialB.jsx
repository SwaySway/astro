      ...
      >
        ...
        >
          <MyIcon
            ...
            padding="0px 0px 0px 0px"
            type="favorite"
            {...getOverrideProps(overrides, "MyIcon30552134")}
          ></MyIcon>
          <Text
            fontFamily="Inter"
            fontSize="14px"
          ...
          >
            ...
            >
              <MyIcon
                ...
                padding="0px 0px 0px 0px"
                type="more_horiz"
                {...getOverrideProps(overrides, "MyIcon30553076")}
              ></MyIcon>
            </Flex>
          </Flex>
          <Text
      ...
      >
        ...
        >
          <MyIcon
            ...
            padding="0px 0px 0px 0px"
            type="reply"
            {...getOverrideProps(overrides, "MyIcon30552245")}
          ></MyIcon>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <MyIcon
            ...
            padding="0px 0px 0px 0px"
            type="shuffle"
            {...getOverrideProps(overrides, "MyIcon30552356")}
          ></MyIcon>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIcon30552527")}
          ></MyIcon>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        <MyIcon
          ...
          padding="0px 0px 0px 0px"
          type="share"
          {...getOverrideProps(overrides, "MyIcon30552698")}
        ></MyIcon>
      </Flex>
    </Flex>
  );
