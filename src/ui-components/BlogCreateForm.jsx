...
export default function BlogCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setTags(undefined);
    setCurrentTagsValue(''); // in the reset state function
    setPublished(undefined);
    setErrors({});
  };
  const [currentTagsValue, setCurrentTagsValue] = React.useState(''); // this is in the form-renderer
    ...
    >
      ...
      <ArrayField
        onChange={async (items) => {
          ...
          setTags(values); // set the array item
          setCurrentTagsValue("");
        }}
